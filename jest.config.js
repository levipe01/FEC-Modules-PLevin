...
module.exports = {
  ...
  // An array of glob patterns indicating a set of files for which coverage info should be collected
  ...
  // A map from reg expressions to module names that allow to stub out resources with single module
  // moduleNameMapper: {},
